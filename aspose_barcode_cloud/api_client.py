...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None):
        ...
        self.default_headers = {
            ...
            "x-aspose-client-version": "26.8.0",
        }
        if header_name is not None:
            self.default_headers[header_name] = header_value
        self.cookie = cookie
        # Set default User-Agent.
        self.user_agent = "Aspose-Barcode-SDK/26.8.0/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            if klass.startswith(("List[", "list[")):
                sub_kls = re.match(r"list\[(.*)]", klass, re.I).group(1)
                return [self.__deserialize(sub_data, sub_kls) for sub_data in data]

            if klass.startswith(("Dict(", "dict(")):
                sub_kls = re.match(r"dict\(([^,]*), (.*)\)", klass, re.I).group(2)
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aspose_barcode_cloud.models, klass)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if klass.swagger_types is not None:
            for attr, attr_type in klass.swagger_types.items():
                ...
                if data is not None and key in data and isinstance(data, (list, dict)):
                    value = data[key]
